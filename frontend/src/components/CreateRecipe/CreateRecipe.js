    ...
    useEffect(() => {
        ...
        const fetchIngredients = async () => {
            try {
                ...
                const categorized = categorizeIngredients(data);
                ...
                const mockIngredients = [
                    { id: 1, name: "Onion", unit: "piece", category: "vegetables" },
                    { id: 2, name: "Garlic", unit: "clove", category: "vegetables" },
                    { id: 3, name: "Olive Oil", unit: "ml", category: "oils_fats" },
                    { id: 4, name: "Salt", unit: "tsp", category: "herbs_spices" },
                    { id: 5, name: "Black Pepper", unit: "tsp", category: "herbs_spices" },
                    { id: 6, name: "Chicken Breast", unit: "g", category: "meat_poultry" },
                    { id: 7, name: "Pasta", unit: "g", category: "grains_cereals" },
                    { id: 8, name: "Parmesan Cheese", unit: "g", category: "dairy" },
                ];

                setAvailableIngredients(mockIngredients);
                const categorized = categorizeIngredients(mockIngredients);
                setCategorizedIngredients(categorized);
                setLoading(false);
            }
        };
